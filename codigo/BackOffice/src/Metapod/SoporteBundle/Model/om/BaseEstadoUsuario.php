...
abstract class BaseEstadoUsuario extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Metapod\\SoporteBundle\\Model\\EstadoUsuarioPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EstadoUsuarioPeer::ID;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = EstadoUsuarioPeer::NOMBRE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EstadoUsuarioPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EstadoUsuarioPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`nombre`';
        }

        $sql = sprintf(
            'INSERT INTO `estado_usuario` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EstadoUsuarioPeer::ID)) $criteria->add(EstadoUsuarioPeer::ID, $this->id);
        if ($this->isColumnModified(EstadoUsuarioPeer::NOMBRE)) $criteria->add(EstadoUsuarioPeer::NOMBRE, $this->nombre);
    ...
    {
        $criteria = new Criteria(EstadoUsuarioPeer::DATABASE_NAME);
        $criteria->add(EstadoUsuarioPeer::ID, $this->id);
