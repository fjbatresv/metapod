...
use Metapod\SoporteBundle\Model\UsuarioQuery;
...
abstract class BaseUsuarioPerfil extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Metapod\\SoporteBundle\\Model\\UsuarioPerfilPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UsuarioPerfilPeer::ID;
        }
    ...
    public function setPerfilId($v)
    {
        ...
        if ($this->perfil_id !== $v) {
            $this->perfil_id = $v;
            $this->modifiedColumns[] = UsuarioPerfilPeer::PERFIL_ID;
        }
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[] = UsuarioPerfilPeer::USUARIO_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = UsuarioPerfilPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UsuarioPerfilQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPerfilPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UsuarioPerfilPeer::PERFIL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`perfil_id`';
        }
        if ($this->isColumnModified(UsuarioPerfilPeer::USUARIO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_id`';
        }

        $sql = sprintf(
            'INSERT INTO `usuario_perfil` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['UsuarioPerfil'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsuarioPerfil'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPerfilPeer::ID)) $criteria->add(UsuarioPerfilPeer::ID, $this->id);
        if ($this->isColumnModified(UsuarioPerfilPeer::PERFIL_ID)) $criteria->add(UsuarioPerfilPeer::PERFIL_ID, $this->perfil_id);
        if ($this->isColumnModified(UsuarioPerfilPeer::USUARIO_ID)) $criteria->add(UsuarioPerfilPeer::USUARIO_ID, $this->usuario_id);
    ...
    {
        $criteria = new Criteria(UsuarioPerfilPeer::DATABASE_NAME);
        $criteria->add(UsuarioPerfilPeer::ID, $this->id);
    ...
    {
        return (string) $this->exportTo(UsuarioPerfilPeer::DEFAULT_STRING_FORMAT);
    }
