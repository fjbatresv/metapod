...
abstract class BaseMenu extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Metapod\\SoporteBundle\\Model\\MenuPeer';
    ...
    public function setMostrar($v)
    {
        ...
        if ($this->mostrar !== $v) {
            $this->mostrar = $v;
            $this->modifiedColumns[] = MenuPeer::MOSTRAR;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = MenuPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = MenuPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->superior = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->mostrar = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->icono = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            return $startcol + 10; // 10 = MenuPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MenuPeer::MOSTRAR)) {
            $modifiedColumns[':p' . $index++]  = '`mostrar`';
        }
        if ($this->isColumnModified(MenuPeer::ICONO)) {
            $modifiedColumns[':p' . $index++]  = '`icono`';
        }
        if ($this->isColumnModified(MenuPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`created_by`';
        }
        if ($this->isColumnModified(MenuPeer::UPDATED_BY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`superior`':
                        ...
                        break;
                    case '`mostrar`':
                        $stmt->bindValue($identifier, $this->mostrar, PDO::PARAM_INT);
                        break;
                    case '`icono`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getRuta(),
            $keys[3] => $this->getSuperior(),
            $keys[4] => $this->getMostrar(),
            $keys[5] => $this->getIcono(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setSuperior($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setMostrar($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setIcono($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuPeer::MOSTRAR)) $criteria->add(MenuPeer::MOSTRAR, $this->mostrar);
        if ($this->isColumnModified(MenuPeer::ICONO)) $criteria->add(MenuPeer::ICONO, $this->icono);
        if ($this->isColumnModified(MenuPeer::CREATED_BY)) $criteria->add(MenuPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(MenuPeer::UPDATED_BY)) $criteria->add(MenuPeer::UPDATED_BY, $this->updated_by);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMostrar($this->getMostrar());
