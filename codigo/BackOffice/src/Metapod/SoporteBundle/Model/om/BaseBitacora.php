...
abstract class BaseBitacora extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Metapod\\SoporteBundle\\Model\\BitacoraPeer';
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[] = BitacoraPeer::USUARIO_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 14; // 14 = BitacoraPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BitacoraPeer::USUARIO_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BitacoraPeer::USUARIO_ID)) $criteria->add(BitacoraPeer::USUARIO_ID, $this->usuario_id);
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->usuario_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuario->addBitacoras($this);
             */
        }
