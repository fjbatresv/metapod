...
class UsuarioPerfilTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Metapod.SoporteBundle.Model.map.UsuarioPerfilTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Metapod\\SoporteBundle\\Model\\UsuarioPerfil');
    ...
    {
        $this->addRelation('Usuario', 'Metapod\\SoporteBundle\\Model\\Usuario', RelationMap::MANY_TO_ONE, array('usuario_id' => 'id', ), 'CASCADE', 'CASCADE');
        $this->addRelation('Perfil', 'Metapod\\SoporteBundle\\Model\\Perfil', RelationMap::MANY_TO_ONE, array('perfil_id' => 'id', ), null, null);
    } // buildRelations()
