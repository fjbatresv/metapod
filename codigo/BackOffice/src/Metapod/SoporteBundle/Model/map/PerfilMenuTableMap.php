...
class PerfilMenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Metapod.SoporteBundle.Model.map.PerfilMenuTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Metapod\\SoporteBundle\\Model\\PerfilMenu');
    ...
    {
        $this->addRelation('Perfil', 'Metapod\\SoporteBundle\\Model\\Perfil', RelationMap::MANY_TO_ONE, array('perfil_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('Menu', 'Metapod\\SoporteBundle\\Model\\Menu', RelationMap::MANY_TO_ONE, array('menu_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
